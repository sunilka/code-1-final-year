...
speech("You have choosen the function to get the color infront of you. Camera unlocking please wait")
...
img_counter = 0
speech("Camera unlocked. Press space bar to capture image")
...
speech("Image captured. Guessing the color. Please wait")
img = cv2.imread('C:\\Users\\Shruthi\\Desktop\\b.jpg')
...
try: ## TODO: try catch block per https://wiki.python.org/moin/HandlingExceptions
	...
	ColorName="not found"
print(ColorName)
speech("color is found to be "+ColorName)
